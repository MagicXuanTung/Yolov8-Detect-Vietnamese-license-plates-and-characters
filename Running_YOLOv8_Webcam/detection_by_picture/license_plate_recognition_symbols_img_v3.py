    ...
    for i, r in enumerate(results):
        ...
        for j, box in enumerate(boxes):
            ...
            if classNames[cls] == "license_plate":
                ...
                cv2.drawContours(preprocessed_img, contours, -1, (0, 255, 0), 2)
                ...
                cropped_output_filename = os.path.join(cropped_output_directory, f'{image_filename}_cropped_{i+1}-{j+1}.jpg')
