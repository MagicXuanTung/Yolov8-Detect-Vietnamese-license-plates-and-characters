    ...
    for i, r in enumerate(results):
        ...
        for j, box in enumerate(boxes): 
            ...
            if classNames[cls] == "license_plate":
                ...
                crop_x1 = max(0, x1 - 0)  # Adjust the values to include some margin around the bounding box
                crop_y1 = max(0, y1 - 0)
                ...
                license_plate_text_valid = "".join([char if char in valid_characters else "?" for char in license_plate_text])
                ...
                cropped_output_filename_color = os.path.join(cropped_output_directory_color, f'{image_filename}_cropped_{i+1}-{j+1}_1.jpg')
                ...
                # Check if each character in the recognized text is valid
                license_plate_text_valid2 = "".join([char if char in valid_characters else "?" for char in license_plate_text2])
                ...
                cropped_output_filename_bw = os.path.join(cropped_output_directory_bw, f'{image_filename}_cropped_{i+1}-{j+1}_2.jpg')
